...
class Trainer:
    def __init__(self, task, replay_capacity=50000, replay_histor_len=1,
        ...
        self.replay_memory = ReplayMemory(capacity=replay_capacity, history_len=replay_histor_len, 
                                          num_null_operations=num_null_operations, batch_size=batch_size)
        ...
        self.actor_critic = ActorCritic(num_actions=self.num_actions, max_action=self.high_action, 
                                        ...
                                        replay_memory=self.replay_memory, noise_fn=self.noise_fn)
    ...
    def train(self, num_episodes):
        for episode in range(num_episodes):
            ...
            while True:
                ...
                if step % self.train_interval:
                    training_states, training_actions, training_rewards, training_new_states, training_terminated = self.replay_memory.sample()
